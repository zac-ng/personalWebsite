import { Center, Text, Heading, Grid, GridItem, Button } from "@chakra-ui/react";
...
const Projects = () => {
  return (
    <>
      <Heading textAlign="center" mt="5vh" mb={12}>Projects</Heading>
      <Center mb={12}>
          <Text maxW="70%">
          In my free time I love tinkering on new projects! I'm passionate about building things
          that I can see myself using, or I can see other people using. Most of my projects 
          are mostly full stack, but I try to learn something new with each project. If you 
          like any of projects, feel free to reach out to let me know or fork any 
